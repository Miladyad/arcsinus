...
const prepareFileHandler = (nameId, extId, base64Id, typeData, typeId) => (evt) => {
...
if (window.File && window.FileReader && window.FileList && window.Blob) {
    addFileUploadListener('field2695274', ["#field2702238","#field2702240","#field2702241",'WFC001','#field2702237']) //ЮЛ Карточка
    addFileUploadListener('field2687993', ["#field2706011","#field2706012","#field2706014",'WFC002','#field2706007']) // Устав
	addFileUploadListener('field2687994', ["#field2706019","#field2706021","#field2706023",'WFC003','#field2706016']) // Свидетельство о государственной регистрации
	addFileUploadListener('field2687995', ["#field2706026","#field2706027","#field2706028",'WFC004','#field2706025']) // Решение о создании
	addFileUploadListener('field2687996', ["#field2706030","#field2706031","#field2706032",'WFC005','#field2706029']) // Свидетельство о постановке на учёт в налоговом органе
	addFileUploadListener('field2687997', ["#field2706034","#field2706035","#field2706036",'WFC006','#field2706033']) // Приказ о вступлении в должность действующего руководителя юридического лица
	addFileUploadListener('field2687998', ["#field2706064","#field2706065","#field2706091",'WFC007','#field2706062']) // Решение или протокол об избрании исполнительного органа
	addFileUploadListener('field2687999', ["#field2706093","#field2706134","#field2706153",'WFC008','#field2706092']) // Доверенность, если подписан не исполнительный орган
	addFileUploadListener('field2688000', ["#field2706170","#field2706171","#field2706172",'WFC009','#field2706154']) // Справка об отсутствии задолженности по налогам и сборам
	addFileUploadListener('field2688001', ["#field2706215","#field2706216","#field2706217",'WFC010','#field2706214']) // Бухгалтерский баланс
	addFileUploadListener('field2688003', ["#field2706226","#field2706227","#field2706228",'WFC011','#field2706225']) // Налоговые декларации
	addFileUploadListener('field2688002', ["#field2706230","#field2706231","#field2706232",'WFC012','#field2706229']) // Договор аренды
	addFileUploadListener('field2701270', ["#field2706277","#field2706278","#field2706279",'WFI001','#field2706276']) //ФЛ Карточка
	addFileUploadListener('field2695275', ["#field2706281","#field2706282","#field2706283",'WFI002','#field2706280']) // Копия паспорта
	addFileUploadListener('field2695276', ["#field2706286","#field2706288","#field2706290",'WFI003','#field2706284']) // Свидетельство о государственной регистрации
	addFileUploadListener('field2701271', ["#field2706293","#field2706294","#field2706300",'WFI004','#field2706291']) // Свидетельство о постановке на учёт в налоговом органе
	addFileUploadListener('field2695277', ["#field2706302","#field2706305","#field2706309",'WFI005','#field2706301']) // Доверенность, если подписант не ИП
	addFileUploadListener('field2701272', ["#field2706311","#field2706315","#field2706316",'WFI006','#field2706310']) // Справка об отсутствии задолженности
	addFileUploadListener('field2695282', ["#field2706319","#field2706320","#field2706321",'WFI007','#field2706317']) // Документ, подтверждающий налогообложение
	addFileUploadListener('field2696821', ["#field2706325","#field2706326","#field2706327",'WFI008','#field2706324']) // Налоговые декларации НДС
	addFileUploadListener('field2695283', ["#field2706331","#field2706333","#field2706334",'WFI009','#field2706329']) // Документ, подтверждающий наличие штата сотрудников*/
} else {
